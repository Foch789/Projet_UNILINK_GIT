...
function CreateListeEtoile(idListe, nbEtoile){
	...
	for(i=1; i<=nbEtoile; i++){
		...
		renduListe += "<img id=\"staroff-" + idListe + "-" + i + "\" src=\"./13/asset/img/staroff.gif\" border=\"0\" title=\"" + i + "\" style=\"border-width: 0px; display: block;\">";
		renduListe += "<img id=\"staron-" + idListe + "-" + i + "\" src=\"./13/asset/img/staron.gif\" border=\"0\" title=\"" + i + "\" style=\"border-width: 0px; display: none;\">";
		renduListe += "</a>";
		renduListe += "</li>";
	}
